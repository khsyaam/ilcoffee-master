...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Produk Beans</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/adminproduk" style="text-decoration:none">Beranda</a></li>
            <li class="breadcrumb-item active">Produk Beans</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <!-- general form elements -->  
            ...
            <h3 class="card-title">Form Input Produk Beans</h3>
            </div>
        
            <form role="form" method="post" action="/adminproduk" enctype="multipart/form-data">
                @csrf
            <div class="card-body">
	    ...
	    <div class="col-md-8">
	  	<div class="card">
	  	<div class="header">
			  <h4 class="title">List Produk Beans</h4>
		    ...
		    <div class="content table-responsive table-full-width">
		      <table class="table table-striped" id="example">
                  ...
                  <td>{{ $pb->foto }}</td>
									<td>
                  <a href="/adminproduk/detail/{{ $pb->id }}" class="badge badge-primary float-right"><i class="fa fa-cog"></i>  Detail</a>
                </td>
								</tr>
              @endforeach
						</tbody>
